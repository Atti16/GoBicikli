...
function calcDiscount() {
    ...
    if (basket.length !== 0) {
        ...
        document.getElementById("currPrice1").innerHTML = Math.round(sum * 0.9); 
        document.getElementById("currPrice2").innerHTML = Math.round(sum * 0.85); 
        document.getElementById("currPrice3").innerHTML = Math.round(sum * 0.95); 
    } else {
